...
const UserList = () => {
	...
	const { data, isLoading, isError, refetch } = useQuery({
		queryKey: ['users', currentPage, sortBy, sortOrder, search, active, roles, recordsPerPage],
		queryFn: () =>
			fetchUsers(currentPage, sortBy, sortOrder, search, active, roles, recordsPerPage),
	});
